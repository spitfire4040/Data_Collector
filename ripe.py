...
def trace():
	...
	for node in nodeList:
		...
		if not os.path.exists("/home/jay/Desktop/Data_Collector/RipeData/" + str(start_time) + "/all_nodes"):
			os.makedirs("/home/jay/Desktop/Data_Collector/RipeData/" + str(start_time) + "/all_nodes")

		if not os.path.exists("/home/jay/Desktop/Data_Collector/RipeData/" + str(start_time) + "/per_node/" + node):
			os.makedirs("/home/jay/Desktop/Data_Collector/RipeData/" + str(start_time) + "/per_node/" + node)
		...
		of3 = open("src.txt", "w")
		of4 = open("dst.txt", "w")
		of5 = open("/home/jay/Desktop/Data_Collector/RipeData/" + str(start_time) + "/per_node/" + node + "/stats.txt", "w")		
		of6 = open("/home/jay/Desktop/Data_Collector/RipeData/" + str(start_time) + "/per_node/" + node + "/trace.txt", "w")
		of7 = open("/home/jay/Desktop/Data_Collector/RipeData/" + str(start_time) + "/per_node/" + node + "/ip.txt", "w")
		of8 = open("/home/jay/Desktop/Data_Collector/RipeData/" + str(start_time) + "/per_node/" + node + "/src.txt", "w")
		of9 = open("/home/jay/Desktop/Data_Collector/RipeData/" + str(start_time) + "/per_node/" + node + "/dst.txt", "w")
		of10 = open("/home/jay/Desktop/Data_Collector/RipeData/" + str(start_time) + "/per_node/" + node + "/traceCount.txt", "w")
		of11 = open("/home/jay/Desktop/Data_Collector/RipeData/" + str(start_time) + "/per_node/" + node + "/edgeList.txt", "w")
		of15 = open("/home/jay/Desktop/Data_Collector/RipeData/" + str(start_time) + "/per_node/" + node + "/ipCount.txt", "w")
		ofx = open("/home/jay/Desktop/Data_Collector/RipeData/" + str(start_time) + "/all_nodes/stats.txt", "w")	

		try:
			# download page from internet and store in filesystem
			urllib.urlretrieve("https://atlas.ripe.net/api/v2/measurements/" + node + "/results?start=" + str(start_time) + "&stop=" + str(end_time) + "&format=json", "/home/jay/Desktop/Data_Collector/ripe.json")
	...
	# unique traces
	of11 = open("/home/jay/Desktop/Data_Collector/RipeData/" + str(start_time) + "/all_nodes/traces.txt", "w")
	...
	# unique ip addresses
	of12 = open("/home/jay/Desktop/Data_Collector/RipeData/" + str(start_time) + "/all_nodes/ips.txt", "w")
	for item in uniqueIP:
		of12.write(item)
		ipCount3 += 1
	of12.close()
	...
	of13 = open("/home/jay/Desktop/Data_Collector/RipeData/" + str(start_time) + "/all_nodes/src.txt", "w")
	...
	of14 = open("/home/jay/Desktop/Data_Collector/RipeData/" + str(start_time) + "/all_nodes/dst.txt", "w")
	...
	of15 = open("/home/jay/Desktop/Data_Collector/RipeData/" + str(start_time) + "/all_nodes/edges.txt", "w")
